...
import TableExtractor from '../../../components/pdf/TableExtractor';
import dynamic from 'next/dynamic';

function TableExtractorPage() {
...
export default dynamic(() => Promise.resolve(TableExtractorPage), {
  ssr: false,
  loading: () => (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center">
      <div className="text-center">
        <div className="w-16 h-16 border-4 border-[#00C7BE] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
        <p className="text-[#086C67] font-semibold">Loading Table Extractor...</p>
      </div>
    </div>
  )
});