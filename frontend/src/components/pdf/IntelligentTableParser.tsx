...
const IntelligentTableParser: React.FC = () => {
  ...
  const startAzureDIAnalysis = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.detail || 'Failed to start intelligent table analysis');
      }
      ...
      setError(err.message || 'Failed to start intelligent table analysis');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (result.status === 'SUCCEEDED') {
            ...
            clearInterval(pollInterval);
            setPolling(false);
            setError(result.error || 'Azure Document Intelligence analysis failed');
          }
        }
      } catch (err) {
  ...
  const exportData = async (format: 'csv' | 'xlsx' | 'json' | 'xml' | 'txt') => {
    ...
    try {
      ...
      if (extractedTables && extractedTables.length > 1) {
        a.download = `intelligent-tables.zip`;
      } else {
        a.download = `intelligent-tables-azure.${format}`;
      }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Advanced Azure-powered intelligent table extraction. Upload your PDF and let cutting-edge AI extract all table data with superior accuracy.
          </p>
        </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="lg:w-80">
                <div className="bg-gradient-to-br from-[#00C7BE]/5 to-[#086C67]/5 rounded-2xl p-6 border">
                  ...
                  <p className="text-gray-600 mb-6">
                    Our Azure-powered AI will intelligently analyze your document and extract all table data with superior accuracy. This process typically takes 30-60 seconds.
                  </p>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-3xl shadow-xl p-12 border border-gray-100 text-center">
              <div className="mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  {azureDIJob.status === 'IN_PROGRESS' 
                    ? 'Azure Document Intelligence is analyzing your document for intelligent table extraction...' 
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-2xl font-bold text-gray-900 flex items-center">
                ...
                Intelligent Tables ({extractedTables.length})
              </h3>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                {extractedTables.length > 1 
                  ? `${extractedTables.length} intelligent tables have been extracted and are ready to download as individual files.`
                  : 'Your table data has been intelligently extracted and is ready to download.'
                }
              </p>
            </div>
...
export default IntelligentTableParser;